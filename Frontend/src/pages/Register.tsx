          ...
          <div className="relative flex h-full flex-col justify-between p-12 xl:p-16">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-8 max-w-xl text-5xl font-semibold leading-[1.08] tracking-tight text-gray-950 xl:text-6xl">
                Your account,
                <br />
                <span className="text-[#f47c0b]">your control.</span>
              </h2>

              <p className="mt-7 max-w-lg text-base leading-7 text-gray-500">
                Everything you need to securely manage your account, verify your
                identity and keep your information protected.
              </p>
            </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold">AuthFlow</span>
                  </div>
            ...
            <div className="mt-16 grid grid-cols-3 gap-5 border-t border-black/10 pt-7">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900">02</p>

                <p className="mt-1 text-xs text-gray-500">Email verification</p>
              </div>

              <div>
                <p className="text-lg font-semibold text-gray-900">03</p>

                <p className="mt-1 text-xs text-gray-500">Protected account</p>
              </div>
            </div>
          </div>
        </div>
